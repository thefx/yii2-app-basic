...
class ActionColumn extends Column
{
    ...
    protected function initDefaultButtons()
    {
        ...
        $this->initDefaultButton('update', 'fa fa-edit');
        $this->initDefaultButton('delete', 'fa fa-trash text-danger', [
            ...
            $this->buttons[$name] = function ($url, $model, $key) use ($name, $iconName, $additionalOptions) {
                switch ($name) {
                    ...
                    case 'update':
                        ...
                        break;
                    case 'delete':
                        $title = '<span class="text-danger">' . Yii::t('yii', 'Delete') . '</span>';
                        break;
                    default:
                        $title = ucfirst($name);
                }
                ...
                $icon = Html::tag('span', '', ['class' => "$iconName position-left"]);
    ...
    {
        $tmpl = preg_replace_callback('/\\{([\w\-\/]+)\\}/', function ($matches) use ($model, $key, $index) {
            $name = $matches[1];
            ...
            if ($isVisible && isset($this->buttons[$name])) {
                ...
                $divider = $name == 'delete' ? '<li class="divider"></li>' : '';
                return $divider . '<li class="dropdown-item">' . call_user_func($this->buttons[$name], $url, $model, $key) . '</li>';
            }
